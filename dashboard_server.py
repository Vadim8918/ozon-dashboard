...
PRODUCT_VOLUMES_PATH = CACHE_DIR / "product_volumes.json"
...
OZON_ENDPOINTS = [
    {
        ...
        "name": "Р¤РёРЅР°РЅСЃРѕРІС‹Рµ РѕРїРµСЂР°С†РёРё",
        "hint": "РўСЏР¶РµР»С‹Р№ endpoint. РџСЂРё 429 РЅРµ Р·Р°РїСѓСЃРєР°С‚СЊ РїР°СЂР°Р»Р»РµР»СЊРЅРѕ РґР»СЏ РѕРґРЅРѕРіРѕ Seller ID; РґРµСЂР¶Р°С‚СЊ РїРѕСЃР»РµРґРѕРІР°С‚РµР»СЊРЅСѓСЋ РѕС‡РµСЂРµРґСЊ Рё РїР°СѓР·Сѓ 2-5 СЃРµРєСѓРЅРґ РјРµР¶РґСѓ С‚СЏР¶РµР»С‹РјРё Р·Р°РїСЂРѕСЃР°РјРё.",
    },
    {"path": "/v1/finance/realization/by-day", "name": "РќР°С‡РёСЃР»РµРЅРёСЏ Р·Р° РґРµРЅСЊ", "hint": "РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РґР»СЏ РІС‹СЂСѓС‡РєРё, РїСЂРѕРіСЂР°РјРј РїР°СЂС‚РЅРµСЂРѕРІ Рё Р±Р°Р»Р»РѕРІ Р·Р° СЃРєРёРґРєРё РїРѕ СЃРІРµР¶РёРј РґРЅСЏРј."},
    {"path": "/v2/finance/realization", "name": "РќР°С‡РёСЃР»РµРЅРёСЏ Р·Р° РјРµСЃСЏС†", "hint": "РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РґР»СЏ РјРµСЃСЏС‡РЅРѕР№ РІС‹СЂСѓС‡РєРё, РїСЂРѕРіСЂР°РјРј РїР°СЂС‚РЅРµСЂРѕРІ Рё Р±Р°Р»Р»РѕРІ Р·Р° СЃРєРёРґРєРё."},
    {"path": "/v2/posting/fbo/list", "name": "Р—Р°РєР°Р·С‹ FBO", "hint": "Р”Р»СЏ Р±РѕР»СЊС€РёС… РїРµСЂРёРѕРґРѕРІ Ozon РјРѕР¶РµС‚ РІРµСЂРЅСѓС‚СЊ MAX_OFFSET_EXCEEDED; Р»СѓС‡С€Рµ РґСЂРѕР±РёС‚СЊ РїРµСЂРёРѕРґ."},
    {"path": "/v3/posting/fbs/list", "name": "Р—Р°РєР°Р·С‹ FBS", "hint": "Р—Р°РєР°Р·С‹ FBS РїРѕ РІС‹Р±СЂР°РЅРЅРѕРјСѓ РїРµСЂРёРѕРґСѓ."},
    {"path": "/v3/product/list", "name": "РЎРїРёСЃРѕРє С‚РѕРІР°СЂРѕРІ", "hint": "РљСЌС€ С‚РѕРІР°СЂРѕРІ РѕР±РЅРѕРІР»СЏРµС‚СЃСЏ РѕС‚РґРµР»СЊРЅРѕ."},
    {"path": "/v3/product/info/list", "name": "РРЅС„РѕСЂРјР°С†РёСЏ Рѕ С‚РѕРІР°СЂР°С…", "hint": "Р”РµС‚Р°Р»СЊРЅС‹Рµ РґР°РЅРЅС‹Рµ РїРѕ С‚РѕРІР°СЂР°Рј РїР°С‡РєР°РјРё."},
    {"path": "/v5/product/info/prices", "name": "Р¦РµРЅС‹ С‚РѕРІР°СЂРѕРІ", "hint": "Р¦РµРЅС‹ Рё СЃРєРёРґРєРё РїРѕ С‚РѕРІР°СЂР°Рј РїР°С‡РєР°РјРё."},
    {"path": "/v4/product/info/stocks", "name": "РћСЃС‚Р°С‚РєРё С‚РѕРІР°СЂРѕРІ", "hint": "РћСЃС‚Р°С‚РєРё FBO/FBS РїРѕ С‚РѕРІР°СЂР°Рј."},
    {"path": "/v4/product/info/attributes", "name": "РђС‚СЂРёР±СѓС‚С‹ С‚РѕРІР°СЂРѕРІ", "hint": "РљР°С‚РµРіРѕСЂРёРё, С‚РёРїС‹, РўРќР’Р­Р” Рё СЃРІРѕР№СЃС‚РІР° С‚РѕРІР°СЂРѕРІ."},
    {"path": "/v1/description-category/tree", "name": "Р”РµСЂРµРІРѕ РєР°С‚РµРіРѕСЂРёР№", "hint": "РЎРїСЂР°РІРѕС‡РЅРёРє РєР°С‚РµРіРѕСЂРёР№ Ozon."},
]
...
def default_account_name(client_id: str) -> str:
    return "Р¤РёР»СЊРєРёРЅР° Р“СЂР°РјРѕС‚Р°" if str(client_id).strip() == "3801" else "Ozon Р°РєРєР°СѓРЅС‚"
...
MOJIBAKE_RE = re.compile(r"[РС][\u0400-\u04ff]")
...
def fix_mojibake(value: str) -> str:
    ...
    if fixed != value and not MOJIBAKE_RE.search(fixed):
        return fixed

    bad_before = len(MOJIBAKE_RE.findall(value))
    bad_after = len(MOJIBAKE_RE.findall(fixed))
    cyr_before = len(re.findall(r"[А-Яа-яЁё]", value))
    cyr_after = len(re.findall(r"[А-Яа-яЁё]", fixed))
    if bad_after < bad_before or cyr_after > cyr_before:
        return fixed
    return value


def normalize_json_texts(value: Any) -> Any:
    if isinstance(value, str):
        return fix_mojibake(value)
    if isinstance(value, list):
        return [normalize_json_texts(item) for item in value]
    if isinstance(value, dict):
        return {
            fix_mojibake(key) if isinstance(key, str) else key: normalize_json_texts(item)
...
def date_range(date_from_value: str, date_to_value: str) -> tuple[str, str, str]:
    if not re.fullmatch(r"\d{4}-\d{2}-\d{2}", date_from_value or ""):
        raise ValueError("Р’С‹Р±РµСЂРёС‚Рµ РґР°С‚Сѓ РЅР°С‡Р°Р»Р°.")
    if not re.fullmatch(r"\d{4}-\d{2}-\d{2}", date_to_value or ""):
        raise ValueError("Р’С‹Р±РµСЂРёС‚Рµ РґР°С‚Сѓ РѕРєРѕРЅС‡Р°РЅРёСЏ.")
    ...
    if end < start:
        raise ValueError("Р”Р°С‚Р° РѕРєРѕРЅС‡Р°РЅРёСЏ РЅРµ РјРѕР¶РµС‚ Р±С‹С‚СЊ СЂР°РЅСЊС€Рµ РґР°С‚С‹ РЅР°С‡Р°Р»Р°.")
    return (
...
def cyrillic_score(text: str) -> int:
    ...
    mojibake = sum(text.count(token) for token in MOJIBAKE_TOKENS)
    return cyrillic - mojibake * 3
...
def clean_display_text(value: Any) -> str:
    ...
    if not text:
        return ""
    best = text
    best_score = cyrillic_score(text)
...
def is_ad_operation(operation: dict[str, Any]) -> bool:
    ...
    return bool(
        re.search(
            r"СЂРµРєР»Р°Рј|С‚СЂР°С„Р°СЂРµС‚|РїСЂРѕРґРІРёР¶|Р±СЂРµРЅРґРѕРІ|РѕРїР»Р°С‚Р° Р·Р° РєР»РёРє|РєР»РёРє|advert|promotion|marketing|cpc|cpa",
            text,
        )
    )
...
GENERAL_COST_TITLES = {
    "OperationMarketplaceSupplyAdditional": "РћР±СЂР°Р±РѕС‚РєР° РіСЂСѓР·РѕРјРµСЃС‚Р° FBO",
    "MarketplaceServiceItemCrossdocking": "РљСЂРѕСЃСЃ-РґРѕРєРёРЅРі",
    "OperationMarketplaceItemAdditionalPackagingAtWarehouse": "Р”РѕРї. СѓРїР°РєРѕРІРєР° РЅР° СЃРєР»Р°РґРµ",
    "MarketplaceRedistributionOfAcquiringOperation": "РљРѕСЂСЂРµРєС‚РёСЂРѕРІРєР° СЌРєРІР°Р№СЂРёРЅРіР°",
}
...
OPERATION_TITLES = {
    **GENERAL_COST_TITLES,
    ...
    "MarketplaceServiceItemDirectFlowLogistic": "РњР°РіРёСЃС‚СЂР°Р»СЊРЅР°СЏ Р»РѕРіРёСЃС‚РёРєР°",
    "MarketplaceServiceItemRedistributionLastMileCourier": "РџРѕСЃР»РµРґРЅСЏСЏ РјРёР»СЏ РєСѓСЂСЊРµСЂРѕРј",
    "MarketplaceServiceItemRedistributionDropOffApvz": "РџСЂРёРµРј РѕС‚РїСЂР°РІР»РµРЅРёСЏ РІ РџР’Р—",
    "MarketplaceServiceItemDropoffPVZ": "РћР±СЂР°Р±РѕС‚РєР° РѕС‚РїСЂР°РІР»РµРЅРёСЏ РІ РџР’Р—",
    "MarketplaceServiceItemDeliveryToHandoverPlaceOzon": "Р”РѕСЃС‚Р°РІРєР° РґРѕ РјРµСЃС‚Р° РїРµСЂРµРґР°С‡Рё Ozon",
    "MarketplaceServiceItemRedistributionReturnsPVZ": "Р’РѕР·РІСЂР°С‚ С‡РµСЂРµР· РџР’Р—",
    "MarketplaceServiceItemReturnFlowLogistic": "РћР±СЂР°С‚РЅР°СЏ Р»РѕРіРёСЃС‚РёРєР°",
    "MarketplaceServiceSellerReturnsCargoAssortment": "РћР±СЂР°Р±РѕС‚РєР° РІРѕР·РІСЂР°С‚РЅРѕРіРѕ РіСЂСѓР·РѕРјРµСЃС‚Р°",
    "MarketplaceServiceProductMovementFromWarehouse": "РџРµСЂРµРјРµС‰РµРЅРёРµ С‚РѕРІР°СЂР° СЃРѕ СЃРєР»Р°РґР°",
    "MarketplaceServiceItemDisposalDetailed": "РЈС‚РёР»РёР·Р°С†РёСЏ С‚РѕРІР°СЂР°",
    "MarketplaceServiceItemPackageMaterialsProvision": "РџСЂРµРґРѕСЃС‚Р°РІР»РµРЅРёРµ СѓРїР°РєРѕРІРѕС‡РЅС‹С… РјР°С‚РµСЂРёР°Р»РѕРІ",
    "MarketplaceServiceItemPackageRedistribution": "РЈРїР°РєРѕРІРєР° С‚РѕРІР°СЂР° РїР°СЂС‚РЅРµСЂР°РјРё",
    "OperationMarketplaceCostPerClick": "РћРїР»Р°С‚Р° Р·Р° РєР»РёРє",
    "OperationMarketplacePackageMaterialsProvision": "РџСЂРµРґРѕСЃС‚Р°РІР»РµРЅРёРµ СѓРїР°РєРѕРІРѕС‡РЅС‹С… РјР°С‚РµСЂРёР°Р»РѕРІ",
    "OperationMarketplacePackageRedistribution": "РЈРїР°РєРѕРІРєР° С‚РѕРІР°СЂР° РїР°СЂС‚РЅРµСЂР°РјРё",
    "OperationMarketplaceServiceStorage": "РЈСЃР»СѓРіР° СЂР°Р·РјРµС‰РµРЅРёСЏ С‚РѕРІР°СЂРѕРІ РЅР° СЃРєР»Р°РґРµ",
    "OperationAgentDeliveredToCustomer": "Р”РѕСЃС‚Р°РІРєР° РїРѕРєСѓРїР°С‚РµР»СЋ",
    "OperationItemReturn": "Р’РѕР·РІСЂР°С‚ С‚РѕРІР°СЂР°",
    "OperationReturnGoodsFBSofRMS": "Р’РѕР·РІСЂР°С‚ FBS",
    "OperationSellerReturnsCargoAssortmentValid": "Р’РѕР·РІСЂР°С‚РЅРѕРµ РіСЂСѓР·РѕРјРµСЃС‚Рѕ",
    "SellerReturnsDeliveryToPickupPoint": "Р”РѕСЃС‚Р°РІРєР° РІРѕР·РІСЂР°С‚Р° РґРѕ РџР’Р—",
    "DisposalAutomaticForCancellationAndReturns": "РЈС‚РёР»РёР·Р°С†РёСЏ РїРѕСЃР»Рµ РѕС‚РјРµРЅС‹ РёР»Рё РІРѕР·РІСЂР°С‚Р°",
}


def readable_operation_title(value: Any) -> str:
    raw = str(value or "").strip()
    return clean_display_text(OPERATION_TITLES.get(raw, raw))
...
def summarize_general_extra_costs(operations: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for operation in operations:
        amount = operation_amount(operation)
        operation_type = str(operation.get("operation_type") or "")
        operation_name = str(operation.get("operation_type_name") or operation_type or operation.get("type") or "Р Р°СЃС…РѕРґ")
        service_total = abs(operation_service_total(operation))
        formula_amount = (
        ...
        title = clean_display_text(GENERAL_COST_TITLES.get(operation_type, operation_name))
        row = rows.setdefault(
            title,
            {
                "name": title,
...
def add_operation_summary_row(
    ...
    if abs(amount) < 0.01:
        return
    group_name = clean_display_text(group_name)
    item_name = clean_display_text(item_name)
...
def summarize_all_operations(operations: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for operation in operations:
        ...
        if abs(sale_commission) >= 0.01:
            add_operation_summary_row(groups, "РљРѕРјРёСЃСЃРёРё", "Р’РѕР·РЅР°РіСЂР°Р¶РґРµРЅРёРµ Ozon", sale_commission)
...
def summarize_finance(operations: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for operation in operations:
        ...
        if "РІРѕР·РІСЂР°С‚" in operation_text(operation) or "return" in operation_text(operation):
            returns += abs(amount)
...
def summarize_finance_by_category(operations: list[dict[str, Any]], products: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for operation in operations:
        ...
        returns = abs(operation_amount(operation)) * weight if "РІРѕР·РІСЂР°С‚" in operation_text(operation) or "return" in operation_text(operation) else 0.0
        paid_storage = 0.0
...
ORDER_STATUS_TITLES = {
    ...
    "delivering": "Р”РѕСЃС‚Р°РІР»СЏРµС‚СЃСЏ",
    "cancelled": "РћС‚РјРµРЅРµРЅРѕ",
    "awaiting_deliver": "РћР¶РёРґР°РµС‚ РѕС‚РіСЂСѓР·РєРё",
    "awaiting_packaging": "РћР¶РёРґР°РµС‚ СЃР±РѕСЂРєРё",
    "posting_created": "РЎРѕР·РґР°РЅРѕ",
    "acceptance_in_progress": "РџСЂРёРµРјРєР°",
    "arbitration": "РђСЂР±РёС‚СЂР°Р¶",
    "client_arbitration": "РђСЂР±РёС‚СЂР°Р¶ РєР»РёРµРЅС‚Р°",
    "driver_pickup": "РџРµСЂРµРґР°РЅРѕ РІРѕРґРёС‚РµР»СЋ",
    "not_accepted": "РќРµ РїСЂРёРЅСЏС‚Рѕ",
    "sent_by_seller": "РћС‚РїСЂР°РІР»РµРЅРѕ РїСЂРѕРґР°РІС†РѕРј",
        ...
        rows.append(
            {
                ...
                "status": statuses.get("status_name") or ("Р’ Р°СЂС…РёРІРµ" if product.get("archived") else ""),
...
def save_tariffs_upload(file_name: str, file_type: str, file_size: Any, file_data: str) -> dict[str, Any]:
    if not file_data:
        raise ValueError("Р¤Р°Р№Р» С‚Р°СЂРёС„РѕРІ РЅРµ РїРµСЂРµРґР°РЅ.")
    safe_name = safe_upload_filename(file_name)
    suffix = Path(safe_name).suffix.lower()
    if suffix not in {".xlsx", ".csv"}:
        raise ValueError("Р—Р°РіСЂСѓР·РёС‚Рµ С„Р°Р№Р» С‚Р°СЂРёС„РѕРІ РІ С„РѕСЂРјР°С‚Рµ Excel .xlsx РёР»Рё CSV.")
...
def xlsx_rows_from_bytes(content: bytes, max_columns: int = 40) -> list[list[str]]:
...
def csv_rows_from_bytes(content: bytes, max_columns: int = 40) -> list[list[str]]:
...
def load_tariffs_preview() -> dict[str, Any]:
    ...
    if not file_path.exists():
        return {"file": meta, "rows": [], "error": "Р¤Р°Р№Р» С‚Р°СЂРёС„РѕРІ РЅРµ РЅР°Р№РґРµРЅ РЅР° РґРёСЃРєРµ."}
    content = file_path.read_bytes()
    suffix = file_path.suffix.lower()
    rows = csv_rows_from_bytes(content) if suffix == ".csv" else xlsx_rows_from_bytes(content)
    return {"file": meta, "rows": rows, "limited": False}


def normalize_tariff_type(value: Any) -> str:
    return re.sub(r"\s+", " ", clean_display_text(str(value or "")).strip()).casefold()


def parse_tariff_percent(value: Any) -> float | None:
...
def load_tariff_rates_by_type() -> dict[str, Any]:
    meta = load_tariffs_meta()
    if not meta:
        return {}
    file_path = Path(str(meta.get("path") or ""))
    ...
    try:
        content = file_path.read_bytes()
        rows = csv_rows_from_bytes(content) if file_path.suffix.lower() == ".csv" else xlsx_rows_from_bytes(content, max_columns=13)
    except (OSError, ValueError, zipfile.BadZipFile, ET.ParseError):
        return {}

    rates_by_category_type: dict[str, dict[str, dict[str, float]]] = {}
    rates_by_type: dict[str, dict[str, dict[str, float]]] = {}
    for row in rows:
        if len(row) < 12:
            continue
        category = normalize_tariff_type(row[0])
        product_type = normalize_tariff_type(row[2])
        if not product_type or product_type in {"тип товара", "type"}:
            continue
        fbo_under_100 = parse_tariff_percent(row[3])
        fbo_from_100_to_300 = parse_tariff_percent(row[4])
        fbo_over_300 = parse_tariff_percent(row[5])
        fbs_under_100 = parse_tariff_percent(row[9])
        fbs_from_100_to_300 = parse_tariff_percent(row[10])
        fbs_over_300 = parse_tariff_percent(row[11])
        if (
            fbo_under_100 is None
            and fbo_from_100_to_300 is None
            and fbo_over_300 is None
            and fbs_under_100 is None
            and fbs_from_100_to_300 is None
            and fbs_over_300 is None
        ):
            continue
        rate = {
            "fbo": {
                "under_100": fbo_under_100 or 0.0,
                "from_100_to_300": fbo_from_100_to_300 or 0.0,
                "over_300": fbo_over_300 or 0.0,
            },
            "fbs": {
                "under_100": fbs_under_100 or 0.0,
                "from_100_to_300": fbs_from_100_to_300 or 0.0,
                "over_300": fbs_over_300 or 0.0,
            },
        }
        if category:
            rates_by_category_type[f"{category}\n{product_type}"] = rate
        rates_by_type.setdefault(product_type, rate)
    return {"by_category_type": rates_by_category_type, "by_type": rates_by_type}
...
def load_product_volumes() -> dict[str, dict[str, Any]]:
    if not PRODUCT_VOLUMES_PATH.exists():
        return {}
    try:
        data = json.loads(PRODUCT_VOLUMES_PATH.read_text(encoding="utf-8"))
    except (OSError, json.JSONDecodeError):
        return {}
    return data if isinstance(data, dict) else {}


def apply_volumes_to_tnved_payload(payload: dict[str, Any]) -> dict[str, Any]:
    volumes = load_product_volumes()
    by_offer_id = volumes.get("by_offer_id") if isinstance(volumes.get("by_offer_id"), dict) else {}
    by_product_id = volumes.get("by_product_id") if isinstance(volumes.get("by_product_id"), dict) else {}
    by_sku = volumes.get("by_sku") if isinstance(volumes.get("by_sku"), dict) else {}
    if not by_offer_id and not by_product_id and not by_sku:
        return payload
    items = payload.get("items")
    if not isinstance(items, list):
        return payload
    for item in items:
        ...
        sku = str(item.get("sku") or "").strip()
        volume = by_offer_id.get(offer_id)
        if volume is None:
            volume = by_product_id.get(product_id)
        if volume is None:
            volume = by_sku.get(sku)
        if volume is not None:
            item["volume_liters"] = volume
    return payload


def tariff_percent_for_price(rates: dict[str, float], price: float) -> float:
    if price <= 100:
        return rates["under_100"]
    if price <= 300:
        return rates["from_100_to_300"]
    return rates["over_300"]


def apply_tariffs_to_tnved_payload(payload: dict[str, Any]) -> dict[str, Any]:
    tariff_rates = load_tariff_rates_by_type()
    rates_by_category_type = tariff_rates.get("by_category_type") or {}
    rates_by_type = tariff_rates.get("by_type") or {}
    if not rates_by_category_type and not rates_by_type:
        return payload
    items = payload.get("items")
    if not isinstance(items, list):
        return payload
    for item in items:
        if not isinstance(item, dict):
            continue
        category = normalize_tariff_type(item.get("category"))
        product_type = normalize_tariff_type(item.get("type"))
        rates = rates_by_category_type.get(f"{category}\n{product_type}") or rates_by_type.get(product_type)
        if not rates:
            continue
        price = money(item.get("discount_price")) or money(item.get("price"))
        item["fbo_commission_percent"] = round(tariff_percent_for_price(rates["fbo"], price), 2)
        item["fbs_commission_percent"] = round(tariff_percent_for_price(rates["fbs"], price), 2)
    return payload
...
def cache_payload(record: dict[str, Any], client_id: str, account_name: str, *, hit: bool, refresh_started: bool) -> dict[str, Any]:
    ...
    apply_volumes_to_tnved_payload(payload)
    apply_tariffs_to_tnved_payload(payload)
...
def fixed_day_report_period_specs() -> list[dict[str, Any]]:
    return [
        {
            "id": "selected_2026_07_07",
            "periods": {
                "current": {
                    "from": "2026-07-07",
                    "to": "2026-07-07",
...
def fixed_day_report_periods() -> dict[str, dict[str, str]]:
    return fixed_day_report_period_specs()[0]["periods"]


def next_scheduled_report_update_after(moment_utc: datetime, hour: int, minute: int, second: int) -> datetime:
    local = moment_utc.astimezone(APP_TZ)
    candidate = local.replace(hour=hour, minute=minute, second=second, microsecond=0)
    while candidate <= local:
        candidate += timedelta(seconds=REPORT_CACHE_TTL_SECONDS)
    return candidate.astimezone(timezone.utc)


def next_default_report_update_after(moment_utc: datetime) -> datetime:
    return next_scheduled_report_update_after(moment_utc, 9, 0, 0)


def next_fixed_day_report_update_after(moment_utc: datetime, spec: dict[str, Any] | None = None) -> datetime:
    spec = spec or fixed_day_report_period_specs()[0]
    return next_scheduled_report_update_after(
        moment_utc,
        int(spec.get("hour", 9)),
        int(spec.get("minute", 0)),
        int(spec.get("second", 0)),
    )


def first_fixed_day_report_update_for_day(moment_utc: datetime, spec: dict[str, Any] | None = None) -> datetime:
    spec = spec or fixed_day_report_period_specs()[0]
    local = moment_utc.astimezone(APP_TZ)
    first_update = local.replace(
...
def parse_period_date(value: Any) -> date:
    text = str(value or "")[:10]
    return datetime.strptime(text, "%Y-%m-%d").date()


def iter_period_days(period: dict[str, str]) -> list[date]:
    try:
        start = parse_period_date(period.get("from"))
        end = parse_period_date(period.get("to"))
    except (TypeError, ValueError):
        return []
    if end < start:
        return []
...
def day_report_period(day: date) -> dict[str, dict[str, str]]:
    day_text = day.isoformat()
    return {"current": {"from": day_text, "to": day_text, "label": day_text}}
...
def summary_group_key(item: dict[str, Any]) -> str:
    parts = []
...
def merge_summary_values(left: Any, right: Any, key: str = "") -> Any:
    ...
    if isinstance(left, dict) and isinstance(right, dict):
        return {
            field: merge_summary_values(left.get(field), right.get(field), field)
    ...
    if isinstance(left, list) and isinstance(right, list):
        ...
        if all(isinstance(item, dict) for item in combined):
            ...
            for item in combined:
                item_key = summary_group_key(item)
                if not item_key:
                    can_group = False
                    break
                if item_key not in grouped:
                    grouped[item_key] = dict(item)
                    ordered_keys.append(item_key)
                else:
                    grouped[item_key] = merge_summary_values(grouped[item_key], item, key)
            if can_group:
                rows = [grouped[item_key] for item_key in ordered_keys]
                if rows and isinstance(rows[0], dict):
                    if any("amount" in row for row in rows):
                        rows.sort(key=lambda row: abs(float(row.get("amount") or 0)), reverse=True)
                    elif any("profit_before_cost" in row for row in rows):
                        rows.sort(key=lambda row: abs(float(row.get("profit_before_cost") or 0)), reverse=True)
                limit = SUMMARY_TOP_LIMITS.get(key)
                return rows[:limit] if limit else rows
        return combined
    return right if left in (None, "", []) else left


def merge_summaries(summaries: list[dict[str, Any]], period: dict[str, str]) -> dict[str, Any]:
    merged: dict[str, Any] = {}
    for summary in summaries:
        merged = merge_summary_values(merged, summary)
    merged["period"] = {
...
def read_combined_daily_report_cache_record(
    client_id: str,
    api_key: str,
    ...
    def collect(period: dict[str, str]) -> list[dict[str, Any]] | None:
        days = iter_period_days(period)
        if not days or len(days) <= 1:
            return None
        records = []
        for day in days:
            record = read_report_period_cache_record_by_dates(client_id, api_key, day_report_period(day))
            if not record:
                return None
            records.append(record)
        return records

    current_records = collect(current_period)
    if not current_records:
        return None
    all_records.extend(current_records)
    current_summary = merge_summaries([record.get("current") or {} for record in current_records], current_period)

    compare_summary = None
    compare_period = periods.get("compare")
    if compare_period:
        compare_records = collect(compare_period)
        if not compare_records:
            return None
        all_records.extend(compare_records)
        compare_summary = merge_summaries([record.get("current") or {} for record in compare_records], compare_period)

    updated_values = [parse_iso_datetime(record.get("updated_at")) for record in all_records if record.get("updated_at")]
    expires_values = [parse_iso_datetime(record.get("expires_at")) for record in all_records if record.get("expires_at")]
    updated_at = max(updated_values) if updated_values else datetime.now(timezone.utc)
    expires_at = min(expires_values) if expires_values else next_month_report_update_after(updated_at)
...
def build_summary(date_from: str, date_to: str, client_id: str | None = None, period_label: str = "") -> dict[str, Any]:
    ...
    notes = [
        "Р РµРєР»Р°РјР° СЃС‡РёС‚Р°РµС‚СЃСЏ РїРѕ С„РёРЅР°РЅСЃРѕРІС‹Рј РѕРїРµСЂР°С†РёСЏРј, РіРґРµ Ozon РѕС‚РґР°РµС‚ СЂРµРєР»Р°РјРЅС‹Р№/РјР°СЂРєРµС‚РёРЅРіРѕРІС‹Р№ С‚РёРї РѕРїРµСЂР°С†РёРё.",
        "Р”Р»СЏ РѕС‚РґРµР»СЊРЅРѕРіРѕ РєР°Р±РёРЅРµС‚Р° Ozon Performance РјРѕР¶РµС‚ РїРѕРЅР°РґРѕР±РёС‚СЊСЃСЏ РѕС‚РґРµР»СЊРЅС‹Р№ СЂРµРєР»Р°РјРЅС‹Р№ С‚РѕРєРµРЅ.",
    ]

    try:
        operations = client.finance_transactions(date_from, date_to)
    except Exception as exc:
        errors.append(f"Р¤РёРЅР°РЅСЃС‹: {exc}")

    try:
        fbo = client.fbo_postings(date_from, date_to)
    except Exception as exc:
        errors.append(f"Р—Р°РєР°Р·С‹ FBO: {exc}")

    try:
        fbs = client.fbs_postings(date_from, date_to)
    except Exception as exc:
        errors.append(f"Р—Р°РєР°Р·С‹ FBS: {exc}")
    ...
    try:
        ...
        if (product_payload.get("cache") or {}).get("loading"):
            notes.append("РљСЌС€ С‚РѕРІР°СЂРѕРІ РµС‰Рµ РѕР±РЅРѕРІР»СЏРµС‚СЃСЏ, РїРѕСЌС‚РѕРјСѓ С‡Р°СЃС‚СЊ РѕРїРµСЂР°С†РёР№ РјРѕР¶РµС‚ РїРѕРїР°СЃС‚СЊ РІ СЃС‚СЂРѕРєСѓ Р±РµР· РєР°С‚РµРіРѕСЂРёРё.")
    except Exception as exc:
        errors.append(f"РљР°С‚РµРіРѕСЂРёРё С‚РѕРІР°СЂРѕРІ: {exc}")
    ...
    if month_period:
        try:
            ...
            if not is_premium_plus_required_error(exc) and not is_realization_report_not_found_error(exc):
                errors.append(f"Р”РµС‚Р°Р»РёР·Р°С†РёСЏ РІС‹СЂСѓС‡РєРё Р·Р° РјРµСЃСЏС†: {exc}")
        ...
        try:
            ...
            if not is_premium_plus_required_error(exc):
                errors.append(f"Р”РµС‚Р°Р»РёР·Р°С†РёСЏ РІС‹СЂСѓС‡РєРё: {exc}")
            finance["sales_breakdown"] = fallback_sales_breakdown(finance)
    else:
        finance["sales_breakdown"] = fallback_sales_breakdown(finance)
        notes.append("Р”РµС‚Р°Р»РёР·Р°С†РёСЏ РІС‹СЂСѓС‡РєРё РЅРµРґРѕСЃС‚СѓРїРЅР° Р·Р° РІС‹Р±СЂР°РЅРЅС‹Р№ РїРµСЂРёРѕРґ, РїРѕСЌС‚РѕРјСѓ РІС‹СЂСѓС‡РєР° РїРѕРєР°Р·Р°РЅР° РѕР±С‰РµР№ СЃСѓРјРјРѕР№.")
        try:
            if notes:
                notes.pop()
            ...
            if not is_premium_plus_required_error(exc) and not is_realization_report_not_found_error(exc):
                errors.append(f"пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ: {exc}")
            finance["sales_breakdown"] = fallback_sales_breakdown(finance)
...
def build_summary_with_period_cache(date_from: str, date_to: str, client_id: str | None = None, period_label: str = "") -> dict[str, Any]:
    ...
    if selected_client_id and api_key:
        ...
        if record:
            ...
            return summary
        combined_record = read_combined_daily_report_cache_record(selected_client_id, api_key, periods)
        if combined_record:
            summary = dict(combined_record.get("current") or {})
            summary["cache"] = {
                "hit": True,
                "updated_at": str(combined_record.get("updated_at") or ""),
                "expires_at": str(combined_record.get("expires_at") or ""),
            }
            return summary
...
def fixed_day_report_refresh_key(client_id: str, spec: dict[str, Any] | None = None) -> str:
    periods = (spec or fixed_day_report_period_specs()[0])["periods"]
    return report_refresh_key(client_id, periods)


def account_fixed_day_report_is_due(account: dict[str, Any], now: datetime, spec: dict[str, Any] | None = None) -> bool:
    client_id = str(account.get("client_id", "")).strip()
    api_key = str(account.get("api_key", ""))
    if not client_id or not api_key:
        return False
    ...
    record = read_report_period_cache_record(client_id, api_key, periods)
    if not record:
        return first_fixed_day_report_update_for_day(now, spec) <= now
    updated_at = parse_iso_datetime(record.get("updated_at"))
    return next_fixed_day_report_update_after(updated_at, spec) <= now


def start_fixed_day_report_background_refresh(account: dict[str, Any], spec: dict[str, Any] | None = None) -> bool:
    client_id = str(account.get("client_id", "")).strip()
    api_key = str(account.get("api_key", ""))
    if not client_id or not api_key:
        return False
    spec = spec or fixed_day_report_period_specs()[0]
    return start_report_period_background_refresh(client_id, api_key, spec["periods"])


def refresh_fixed_day_report_account(account: dict[str, Any], spec: dict[str, Any]) -> None:
    client_id = str(account.get("client_id", "")).strip()
    api_key = str(account.get("api_key", ""))
    if not client_id or not api_key:
        return
    key = fixed_day_report_refresh_key(client_id, spec)
    if key in REPORT_CACHE_REFRESHING:
        return
    REPORT_CACHE_REFRESHING.add(key)
    REPORT_CACHE_REFRESH_STARTED[key] = datetime.now(timezone.utc)
    try:
        build_report_pair_for_periods(client_id, api_key, spec["periods"], background=False)
    except Exception as exc:
        print(f"Fixed day report cache refresh failed for {client_id} {spec.get('id')}: {exc}")
    finally:
        REPORT_CACHE_REFRESHING.discard(key)
        REPORT_CACHE_REFRESH_STARTED.pop(key, None)
...
def run_fixed_day_report_scheduler_once() -> None:
    ...
    for account in config.get("accounts", []):
        if not isinstance(account, dict):
            continue
        for spec in fixed_day_report_period_specs():
            if not account_fixed_day_report_is_due(account, now, spec):
                continue
            refresh_fixed_day_report_account(account, spec)
...
def build_cached_report_pair(
    ...
    selected_client_id, api_key, _account_name = get_ozon_credentials(client_id)
    if not selected_client_id or not api_key:
        raise ValueError("Р вЂ™Р В»Р В°Р Т‘Р ВµР В»Р ВµРЎвЂ  Р ВµРЎвЂ°Р Вµ Р Р…Р Вµ Р Р…Р В°РЎРѓРЎвЂљРЎР‚Р С•Р С‘Р В» Client ID Р С‘ API Key Р Р† Р В°Р Т‘Р СР С‘Р Р…Р С”Р Вµ.")
    ...
    if record:
        return report_cache_response(record, hit=True)
    record = read_combined_daily_report_cache_record(selected_client_id, api_key, periods)
    if record:
        return report_cache_response(record, hit=True)
...
def start_report_period_background_refresh(client_id: str, api_key: str, periods: dict[str, dict[str, str]]) -> bool:
    ...
    def worker() -> None:
        try:
            build_report_pair_for_periods(client_id, api_key, periods, background=False)
        except Exception as exc:
            print(f"Report period cache refresh failed for {client_id} {report_period_cache_key(periods)}: {exc}")
        finally:
            REPORT_CACHE_REFRESHING.discard(key)
            REPORT_CACHE_REFRESH_STARTED.pop(key, None)
...
def report_period_cache_statuses(account: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    for spec in fixed_day_report_period_specs():
        ...
        expires_at = next_fixed_day_report_update_after(updated_at, spec) if updated_at else first_fixed_day_report_update_for_day(now, spec)
        ...
        if stale and not refreshing and expires_at <= now:
            start_report_period_background_refresh(client_id, api_key, periods)
            refreshing = refresh_key in REPORT_CACHE_REFRESHING
        statuses.append(
            {
                "client_id": client_id,
...
class DashboardHandler(BaseHTTPRequestHandler):
    ...
    def send_json(self, status: int, payload: dict[str, Any]) -> None:
        body = json.dumps(normalize_json_texts(payload), ensure_ascii=False).encode("utf-8")
    ...
    def do_POST(self) -> None:
        ...
        if path == "/api/costs/upload":
            ...
            try:
                ...
                if not isinstance(rows, list):
                    raise ValueError("РќРµРІРµСЂРЅС‹Р№ С„РѕСЂРјР°С‚ С„Р°Р№Р»Р° СЃРµР±РµСЃС‚РѕРёРјРѕСЃС‚Рё.")
                rows = normalize_cost_rows(rows)
                if not rows:
                    raise ValueError("Р’ С„Р°Р№Р»Рµ РЅРµ РЅР°Р№РґРµРЅРѕ Р·Р°РїРѕР»РЅРµРЅРЅС‹С… СЃРµР±РµСЃС‚РѕРёРјРѕСЃС‚РµР№ РІ СЃС‚РѕР»Р±С†Рµ G.")
                config = load_config()
        ...
        if path == "/api/admin/users":
            ...
            try:
                ...
                if not re.fullmatch(r"[A-Za-z0-9_.-]{3,40}", login):
                    raise ValueError("Р›РѕРіРёРЅ: 3-40 СЃРёРјРІРѕР»РѕРІ, Р»Р°С‚РёРЅРёС†Р°/С†РёС„СЂС‹/._-.")
                if len(password) < 6:
                    raise ValueError("РџР°СЂРѕР»СЊ РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ РЅРµ РєРѕСЂРѕС‡Рµ 6 СЃРёРјРІРѕР»РѕРІ.")
                config = load_config()
    ...
    def do_DELETE(self) -> None:
        ...
        try:
            ...
            if login == user["login"]:
                raise ValueError("РќРµР»СЊР·СЏ СѓРґР°Р»РёС‚СЊ С‚РµРєСѓС‰РµРіРѕ РІР»Р°РґРµР»СЊС†Р°.")
            config = load_config()
    ...
    def do_GET(self) -> None:
        ...
        if path == "/api/cache":
            ...
            for account in accounts:
                ...
                for spec in fixed_day_report_period_specs():
                    if account_fixed_day_report_is_due(account, fixed_now, spec):
                        start_fixed_day_report_background_refresh(account, spec)
...
def main() -> int:
    ...
    print("РљР»СЋС‡Рё РІРІРѕРґСЏС‚СЃСЏ РІ Р±СЂР°СѓР·РµСЂРµ Рё РЅРµ СЃРѕС…СЂР°РЅСЏСЋС‚СЃСЏ РЅР° РґРёСЃРє.")
    try:
        server.serve_forever()
    except KeyboardInterrupt:
        print("\nРћСЃС‚Р°РЅРѕРІР»РµРЅРѕ.")
    return 0
